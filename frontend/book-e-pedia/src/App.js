...
import OrderReports from "./components/AdminPanel/Reports/OrderReports";
import PaymentReports from "./components/AdminPanel/Reports/PaymentReports";
import CustomerReports from "./components/AdminPanel/Reports/CustomerReports";
import ProductReports from "./components/AdminPanel/Reports/ProductReports";
import CombinedReports from "./components/AdminPanel/Reports/CombinedReports";

import CustomerResetPassword from "./components/CustomerPanel/CustomerResetPassword/CustomerResetPassword";
...
function App() {
  ...
  const noHeaderFooterRoutes = [
    ...
    '/admin/reports/combined-reports',
  ];
  ...
  return (
    <CartContext.Provider value={{cartData,setCartData}}>
      ...
      <Routes>
        ...
        <Route exact path='/customer/reset-password/:token' element={<CustomerResetPassword />} />
        ...
        <Route exact path='/admin/reports/customers' element={<CustomerReports />} />
        <Route exact path='/admin/reports/orders' element={<OrderReports />} />
        <Route exact path='/admin/reports/products' element={<ProductReports />} />
        <Route exact path='/admin/reports/combined-reports' element={<CombinedReports />} />
        <Route exact path='/admin/reports/payments' element={<PaymentReports />} />
      </Routes>
